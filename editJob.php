  ...
  <!--Navigation bar on top of the page-->
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            ?>
       				<form class="form" name="member_signup" action="BackEnd_Script/jobUpdate.php" method="POST">
         				  <div class="row ">
   				            <div class="form-group">
   				                <div class="col-xs-10 col-xs-offset-1" >
   				                    <input type="text" name="jobTitel" class="form-control input-lg" placeholder="Job Title" value="<?php echo $rs["jobTitel"];?>" />
   				        		    </div>
   				            </div>
         				  </div>
                  </br>
                  ...
                  <div class="row">
                    <div class="form-group">
                      <div class="col-xs-10 col-xs-offset-1 slidecontainer">
                        ...
                        <input type="range" name="nplace" min="1" max="30" class="slider" id="myRange" value="<?php echo $rs["range"];?>">
                      </div>
                    </div>
                   </div>
                  </br>
       				    <div class="row">
     				        <div class="form-group">
   				            <div class="col-xs-10 col-xs-offset-1">
   				                <input type="text" name="address" class="form-control input-lg"  placeholder="Address" value="<?php echo $rs["address"];?>" />
   				            </div>
     				        </div>
       				    </div>
   				        </br>
   				        <div class="row">
 				            <div class="form-group">
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="date" name="stDate" class="form-control input-lg"  placeholder="Starting Date" value="<?php echo $rs["stDate"];?>"/>
				                </div>
 				            </div>
 				          </div>
   				        </br>
   				        <div class="row">
   				            <div class="form-group">
   				                <div class="col-xs-10 col-xs-offset-1">
   				                    <input type="date" name="edDate" class="form-control input-lg"  placeholder="Ending Date" value="<?php echo $rs["edDate"];?>"/>
   				                </div>
   				            </div>
   				          </div>
                  </br>
                    <div class="row">
                         <div class="form-group">
                             <div class="col-xs-10 col-xs-offset-1">
                                 <input type="time" name="stTime" class="form-control input-lg"  placeholder="Starting Time" value="<?php echo $rs["stTime"];?>"/>
                             </div>
                         </div>
                     </div>
   				        ...
   				        <div class="row">
   				            <div class="form-group">
   				                <div class="col-xs-10 col-xs-offset-1">
   				                    <input type="text" name="price" class="form-control input-lg"  placeholder="Price" value="<?php echo $rs["price"];?>" />
   				                </div>
   				            </div>
   				        </div>
